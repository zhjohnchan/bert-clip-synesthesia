...
class CausalSelfAttention(nn.Module):
    ...
    def forward(self, x, layer_past=None):
        ...
        if layer_past is None:
            ...
            if hasattr(self.config, "n_unmasked"):
                mask[:self.config.n_unmasked, :self.config.n_unmasked] = 1
            mask = mask.view(1, 1, T, T).to(self.mask)
...
class GPT(nn.Module):
    ...
    def forward_with_past(self, idx=None, embeddings=None, targets=None, past=None, past_length=None):
        # inference only
